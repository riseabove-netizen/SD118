  ...
  // =================================================================
  {
    ...
    days: [
      ...
      },
      {
        ...
        isoDate: '2026-08-19',
        title: 'Ponza → Naples (Molo Luise) · Family Boards',
        subtitle: 'Depart Ponza 04:30 · Dock Marina Molo Luise ~10:30 · Daniel & Marco board · Nonna 12:00 · PM bay cruise or Ischia overnight',
        imageUrl: satelliteImage('14.20,40.81,14.30,40.87', '640,320'),
        imageCaption: 'Marina Molo Luise · Mergellina — Naples',
        overnight: 'Marina Molo Luise · Mergellina OR anchor/dock Ischia (TBD after Nonna boards)',
        dock: {
          marina: 'Marina Molo Luise · Mergellina, Napoli',
          marinaLink: mapsLink('Marina Molo Luise Mergellina Napoli'),
          radioChannel: 'Ch 09',
          eta: '~10:30 Aug 19',
          etd: 'Aug 19 PM cruise (may re-dock Mergellina or overnight Ischia)',
          notes: 'Daniel & Marco board on arrival. Nonna boards ~12:00. Depart dock after Nonna is aboard.',
        },
        events: [
          ...
          { title: 'Daniel & Marco arrive at the dock · board', time: '11:00', highlight: true, details: ['Cabin turnover complete before arrival', 'Welcome + orientation aboard'] },
          { title: 'Nonna arrives at the dock · board', time: '12:00', highlight: true, details: ['Enrico’s mom — stays aboard through Aug 24', 'Family welcome + light bite before departure'] },
          { title: 'Lunch aboard with the whole family', time: '12:30' },
          { title: 'Weigh lines · afternoon cruise (final call)', time: '14:00', highlight: true, details: ['OPTION A — Bay of Naples loop: Posillipo, Vesuvius panorama, return Molo Luise ~18:30', 'OPTION B — Cruise to Ischia (~18 nm, ~2h): anchor Sant’Angelo or dock Casamicciola for the night', 'Captain’s call after lunch based on wind, guest preference, agent availability'] },
          { title: 'Return to Molo Luise (Option A)', time: '18:30', details: ['Re-dock stern-to Mergellina', 'Evening aboard with the family'] },
          { title: 'Dock at Ischia (Option B)', time: '17:00', link: mapsLink('Porto di Casamicciola Ischia'), details: ['Casamicciola or anchor Sant’Angelo — confirm berth with agent en route', 'Dinner ashore or aboard — guest preference'] },
          { title: 'Dinner aboard · family evening', time: '20:30' },
        ],
        leg: {
          label: 'LEG · PONZA → NAPLES',
          route: 'Ponza (Arco Naturale) → Marina Molo Luise, Mergellina',
          sub: 'Depart 04:30 Aug 19 · Arrive ~10:30 Aug 19',
          miles: '75',
          duration: '6h',
          knots: '12',
        },
    ...
    days: [
      {
        ...
        dock: {
          ...
          eta: '~10:30 Aug 19',
          etd: 'Aug 19 PM cruise (may re-dock Mergellina or overnight Ischia)',
          notes: 'Daniel & Marco board on arrival. Nonna boards ~12:00. Depart dock after Nonna is aboard. Danny & Effie join Aug 19 evening.',
        },
        events: [
          { title: 'Depart Ponza — Arco Naturale anchorage', time: '04:30', highlight: true, details: ['Direct to Naples — skipping Ventotene', '~75 nm · ~6h at 12 kn'] },
          ...
          { title: 'Weigh lines · afternoon cruise (final call)', time: '14:00', highlight: true, details: ['OPTION A — Bay of Naples loop: Posillipo, Vesuvius panorama, return Molo Luise ~18:30', 'OPTION B — Cruise to Ischia (~18 nm, ~2h): anchor Sant’Angelo or dock Casamicciola for the night', 'Captain’s call after lunch based on wind, guest preference, agent availability'] },
          { title: 'Return to Molo Luise (Option A)', time: '18:30', details: ['Re-dock stern-to Mergellina', 'Evening aboard with the family'] },
          { title: 'Dock at Ischia (Option B)', time: '17:00', link: mapsLink('Porto di Casamicciola Ischia'), details: ['Casamicciola or anchor Sant’Angelo — confirm berth with agent en route'] },
          { title: 'Danny & Effie arrive (if back at Molo Luise)', time: '19:30', highlight: true, details: ['If we’re at Ischia, they meet the boat there instead — confirm with agent'] },
