  ...
  // =================================================================
  {
    ...
    days: [
      ...
      },
      {
        ...
        isoDate: '2026-08-19',
        title: 'Ventotene → Naples / Capri (TBD)',
        subtitle: 'Morning swim at Ventotene · midday crossing to Naples or Capri · dock/anchor TBD',
        imageUrl: satelliteImage('13.40,40.78,13.50,40.82', '640,320'),
        imageCaption: 'Ventotene · then Bay of Naples',
        overnight: 'Naples (Molo Luise) or Capri (Marina Grande / anchor) · TBD after lunch briefing',
        events: [
          { title: 'Ventotene morning · swim & shore option', time: '08:30', link: mapsLink('Isola di Ventotene'), highlight: true, details: ['If we crossed last night: relax at anchor', 'If we crossed this AM: arrive ~10:30, quick swim / walk ashore', 'Roman harbour + fish ponds visible from the tender'] },
          { title: 'Last swim · lunch on board', time: '11:30', details: ['Tender in ready to lift · secure toys', 'Guests choose: Naples (Molo Luise) or Capri for the night'] },
          { title: 'Weigh anchor · cross to Naples OR Capri', time: '13:00', highlight: true, details: ['→ Naples (Molo Luise): ~55 nm · ~5h30 at 10 kn · ETA ~18:30 · dock stern-to', '→ Capri (Marina Grande or anchor Marina Piccola): ~50 nm · ~5h · ETA ~18:00', 'Final call at lunch — dock/anchor confirmed with agent before departure'] },
          { title: 'Arrive Naples / Capri · dock or anchor', time: '18:30', details: ['Naples: Molo Luise berth, immigration/customs formalities as needed', 'Capri: Marina Grande berth if available, else anchor Marina Piccola', 'Dinner ashore or on board — guest preference'] },
        ],
        leg: {
          label: 'LEG · VENTOTENE → NAPLES / CAPRI',
          route: 'Ventotene → Molo Luise (Naples) or Marina Grande (Capri)',
          sub: 'Midday crossing · final destination TBD at lunch',
          miles: '55',
          duration: '5h30',
          knots: '10',
        },
