...
export const TRIPS: Trip[] = [
  ...
  // =================================================================
  {
    ...
    days: [
      ...
      },
      {
        ...
        isoDate: '2026-09-10',
        title: 'Punta Arenella Natural Pools → Syracuse',
        subtitle: 'Day 37 · Morning swim holes · Afternoon in Ortigia',
        imageUrl: satelliteImage({ west: 15.05, south: 36.85, east: 15.30, north: 37.10 }, { w: 1000, h: 450 }),
        imageCaption: 'Punta Arenella → Syracuse anchorage',
        events: [
          { time: '07:00', title: 'Depart Vendicari for Punta Arenella (18 NM, 2h)', link: mapsLink('Punta Arenella Sicily') },
          { time: '09:00', title: 'Anchor at Punta Arenella — tender to natural pools & swim holes', link: mapsLink('Punta Arenella Sicily'), highlight: true },
          { time: '13:00', title: 'Weigh anchor for Syracuse (~1h) — lunch underway', link: mapsLink('Syracuse Sicily anchorage') },
          { time: '14:00', title: 'Anchor outside Syracuse harbour', link: mapsLink('Porto Grande Siracusa'), highlight: true },
          { title: 'Tender guests ashore for Ortigia city exploration' },
          { title: 'Tender chef ashore for provisioning', link: mapsLink('Mercato di Ortigia Siracusa') },
          { title: 'Highlights ashore: Ortigia old town, Temple of Apollo, Fountain of Arethusa', link: mapsLink('Ortigia Siracusa') },
          { time: '20:30', title: 'Optional dinner ashore — Don Camillo (historic vaulted cellar)', link: mapsLink('Don Camillo Ortigia') },
        ],
        overnight: 'Anchored outside Syracuse',
      },
      {
  ...
  // =================================================================
  // CHAPTER ELEVEN — CORFU (Sep 15)
  // =================================================================
  {
    id: 'corfu-2026',
    name: 'Corfu — Gateway to the Adriatic',
    subtitle: 'Arrive noon Sep 15 · Dock at Marina Gouvia',
    ...
    days: [
      {
        ...
        events: [
          ...
          { title: 'Optional ashore: Venetian-built Old Fortress', link: mapsLink('Old Fortress Corfu') },
          { title: 'Optional ashore: UNESCO Old Town \u2014 Venetian/French/British layers', link: mapsLink('Corfu Old Town UNESCO') },
          { title: 'Optional ashore: Liston promenade & cafés', link: mapsLink('Liston Corfu') },
          { title: 'Optional dinner: Venetian Well', link: mapsLink('Venetian Well Corfu'), details: ['Romantic courtyard dining'] },
        ],
