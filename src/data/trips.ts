...
export const TRIPS: Trip[] = [
  ...
  // =================================================================
  {
    id: 'sardinia-2026',
    name: 'Sardinia → Ponza',
    subtitle: 'Bonifacio · Maddalena · Poltu Quatu · Cala di Volpe · Cala Brandinchi · Cala Luna · Ponza · Aug 12–18',
    ...
    days: [
      ...
      },
      {
        date: 'Sunday · Aug 16',
        isoDate: '2026-08-16',
        title: 'Cala Brandinchi → Cala Luna · Overnight to Ponza',
        subtitle: 'Two calas in one day · Evening departure · Overnight passage to Ponza',
        imageUrl: satelliteImage('9.60,40.20,9.67,40.25', '640,320'),
        imageCaption: 'Cala Luna — limestone arch, accessible only by sea',
        events: [
          { title: 'Depart Cala di Volpe early', time: '05:30', highlight: true, details: ['Position for a 09:00 anchor off Cala Brandinchi'] },
          { title: 'Anchor in front of Cala Brandinchi', time: '09:00', link: mapsLink('Cala Brandinchi Sardinia'), highlight: true, details: ['Caribbean-white sand, shallow turquoise water'], locationImage: satelliteImage('9.68,40.72,9.74,40.77', '320,160') },
          { title: 'Morning swim / tender ashore at Brandinchi' },
          { title: 'Lift anchor — depart Brandinchi', time: '11:00', details: ['~3 h cruise south to Cala Luna'] },
          { title: 'Anchor off Cala Luna', time: '14:00', link: mapsLink('Cala Luna Sardinia'), highlight: true, locationImage: satelliteImage('9.60,40.20,9.67,40.25', '320,160') },
          { title: 'Expedition ashore — limestone arch, caves, long beach walk', details: ['Vivid turquoise · accessible only by sea'] },
          { title: 'Return to boat, secure for passage', time: '18:30' },
          { title: 'Depart Cala Luna for Ponza — overnight passage', time: '19:00', highlight: true, details: ['~15 h to Ponza · ETA 10:00 Aug 17'] },
        ],
        leg: {
          label: 'NIGHT PASSAGE',
          route: 'Cala Luna, Sardinia → Ponza, Pontine Islands',
          sub: 'Depart 19:00 Aug 16 · Arrive ~10:00 Aug 17',
          miles: '180',
          duration: '15h',
          knots: '12',
        },
      },
      {
        date: 'Monday · Aug 17',
        isoDate: '2026-08-17',
        title: 'Ponza — Cala Feola → Chiaia di Luna',
        subtitle: 'Arrive Ponza 10:00 · Two anchorages · Overnight Chiaia di Luna or Frontone',
        imageUrl: satelliteImage('12.93,40.88,13.02,40.93', '640,320'),
        imageCaption: 'Ponza — crescent volcanic island, pastel harbour',
        overnight: 'At anchor · Chiaia di Luna or Spiaggia di Frontone',
        events: [
          { title: 'Arrive Ponza', time: '10:00', link: mapsLink('Ponza Italy'), highlight: true },
          { title: 'Anchor off Cala Feola — natural rock pools', time: '10:30', link: mapsLink('Cala Feola Ponza'), highlight: true, locationImage: satelliteImage('12.94,40.92,12.99,40.95', '320,160') },
          { title: 'Beach expedition — swim, explore the rock pools' },
          { title: 'Return to boat', time: '12:30', highlight: true },
          { title: 'Move to Chiaia di Luna (~45 min)', time: '12:45', link: mapsLink('Chiaia di Luna Ponza'), locationImage: satelliteImage('12.94,40.89,12.99,40.92', '320,160') },
          { title: 'Afternoon at Chiaia di Luna — beneath the volcanic cliffs', details: ['Swim, paddleboard, tender the base of the cliffs'] },
          ...
          { title: 'Anchor overnight at Chiaia di Luna or move to Spiaggia di Frontone if swell picks up', link: mapsLink('Spiaggia di Frontone Ponza') },
        ],
      },
      {
        date: 'Tuesday · Aug 18',
        isoDate: '2026-08-18',
        title: 'Ponza — Grotte di Pilato → Arco Naturale',
        subtitle: 'Morning beach · Cave snorkel · Overnight at Arco Naturale',
        imageUrl: satelliteImage('12.97,40.88,13.02,40.92', '640,320'),
        imageCaption: 'Grotte di Pilato — Tiberius’s Roman moray eel caves',
        overnight: 'At anchor · Arco Naturale di Ponza',
        events: [
          { title: 'Morning beach exploration ashore', time: '09:00', highlight: true, details: ['Back on the boat by 12:00'] },
          { title: 'Back on boat · secure ashore kit', time: '12:00', highlight: true },
          { title: 'Early lunch aboard', time: '12:15' },
          { title: 'Move to Grotte di Pilato', time: '13:00', link: mapsLink('Grotte di Pilato Ponza'), highlight: true, locationImage: satelliteImage('12.97,40.88,13.02,40.92', '320,160') },
          { title: 'Tender expedition · snorkel the caves', time: '13:30', details: ['Tiberius’s Roman moray eel farm', 'Ethereal turquoise light inside the grottoes'] },
          { title: 'Move to Arco Naturale di Ponza (~30 min)', time: '15:00', link: mapsLink('Arco Naturale Ponza'), highlight: true, details: ['Tow the tender — keep it ready for the arch expedition'] },
          { title: 'Tender expedition + photos at the arch', time: '15:45' },
          { title: 'Anchor for the night off Arco Naturale', time: '18:30', highlight: true },
          { title: 'Dinner at anchor — quiet last Ponza night', time: '20:30' },
        ],
      },
    ],
  },
  {
    ...
    subtitle: 'Nonna aboard · Danny & Effie · Daniel & Marco · Big dock party · Aug 19–23',
    startDate: '2026-08-19',
    endDate: '2026-08-23',
    hero: { icon: '🍕', gradient: 'from-red-900 via-rose-800 to-amber-700' },
    guests: 'Nonna (Enrico’s mom) aboard Aug 19–24 · Danny & Effie arrive evening Aug 19 · Daniel & Marco arrive AM Aug 20 · Big dock party Aug 21',
    guestList: [
      { name: 'Enrico' },
      { name: 'Antoniette' },
      { name: 'Nonna', note: 'Enrico’s mom · aboard Aug 19–24' },
      { name: 'Danny', note: 'arrives evening Aug 19' },
      { name: 'Effie', note: 'arrives evening Aug 19' },
      { name: 'Daniel', note: 'arrives AM Aug 20' },
      { name: 'Marco', note: 'arrives AM Aug 20' },
    ],
    days: [
      {
        date: 'Wednesday · Aug 19',
        isoDate: '2026-08-19',
        title: 'Ponza → Naples · Nonna Aboard · Harbour Cruise',
        subtitle: 'Depart Ponza 05:00 · 6h to Naples · Dock Mergellina · Pick up Nonna · Evening: Danny & Effie',
        ...
        dock: {
          ...
          radioChannel: 'Ch 09',
          eta: '~11:00 Aug 19',
          etd: 'Aug 23 evening cruise (return same night)',
          notes: 'Pick up Nonna after docking — she stays aboard through Aug 24. Danny & Effie arrive the evening of Aug 19.',
        },
        events: [
          { title: 'Depart Ponza — Arco Naturale anchorage', time: '05:00', highlight: true, details: ['~6 h cruise to Naples'] },
          { title: 'Arrive Naples — dock Mergellina', time: '11:00', link: mapsLink('Porto di Mergellina Napoli'), highlight: true },
          { title: 'Pick up Nonna (Enrico’s mom) at the dock', time: '12:00', highlight: true, details: ['She stays aboard until Aug 24'] },
          { title: 'Lunch aboard with Nonna' },
          { title: 'Depart for Bay of Naples harbour cruise', time: '15:00', highlight: true, details: ['Slow loop — Posillipo coast, Vesuvius panorama'] },
          { title: 'Return to Mergellina in the evening', time: '18:30' },
          { title: 'Danny & Effie arrive at the dock', time: '19:30', highlight: true },
          { title: 'Welcome dinner aboard', time: '20:30' },
        ],
        leg: {
          label: 'MORNING PASSAGE',
          route: 'Ponza → Naples (Mergellina)',
          sub: 'Depart 05:00 Aug 19 · Arrive ~11:00 Aug 19',
          miles: '75',
          duration: '6h',
          knots: '12',
        },
      },
      {
        ...
        isoDate: '2026-08-20',
        title: 'Naples → Capri or Ischia · Daniel & Marco Aboard',
        subtitle: 'Daniel & Marco arrive AM · Cruise the bay · Return Mergellina in the evening',
        imageUrl: satelliteImage('14.20,40.54,14.27,40.57', '640,320'),
        imageCaption: 'Bay of Naples — Capri or Ischia day cruise',
        overnight: 'Docked · Mergellina',
        events: [
          { title: 'Cabin turnover for Daniel & Marco', time: '07:00' },
          { title: 'Daniel & Marco arrive at the dock', time: '09:00', highlight: true },
          { title: 'Depart Mergellina for Capri or Ischia', time: '10:00', highlight: true, details: ['Pick destination day-of based on wind & guest preference', 'Capri: anchor Marina Piccola / Faraglioni swim', 'Ischia: anchor Sant’Angelo / thermal springs option'] },
          { title: 'Lunch aboard at anchor' },
          { title: 'Afternoon swim · tender · paddleboard' },
          { title: 'Return cruise to Naples', time: '17:30' },
          { title: 'Dock back at Mergellina', time: '19:30', highlight: true },
          { title: 'Dinner aboard — whole family together', time: '20:30' },
        ],
      },
      {
        date: 'Friday · Aug 21',
        ...
        events: [
          ...
          { title: 'Guests + family arrive at the dock', time: '19:30' },
          { title: 'Big family party at Mergellina', time: '20:00', link: mapsLink('Porto di Mergellina Napoli'), highlight: true, details: ['Music, dinner, celebration through the evening', 'Whole family aboard + dockside'] },
        ],
      },
      {
      ...
      },
      {
        date: 'Sunday · Aug 23',
        isoDate: '2026-08-23',
        title: 'Naples — Goodbye Cruise with Nonna, Danny & Effie',
        subtitle: 'Afternoon farewell cruise · Return Mergellina by evening',
        imageUrl: satelliteImage('14.15,40.75,14.28,40.85', '640,320'),
        imageCaption: 'Bay of Naples — farewell loop',
        overnight: 'Docked · Mergellina',
        events: [
          { title: 'Slow family morning aboard', time: '09:00' },
          { title: 'Depart Mergellina for goodbye harbour cruise', time: '14:00', highlight: true, details: ['With Nonna, Danny & Effie', 'Loop Posillipo · Capri viewpoint · Vesuvius panorama'] },
          { title: 'Sunset aperitivo on deck at anchor' },
          { title: 'Return to Mergellina', time: '19:30', highlight: true },
          { title: 'Farewell dinner aboard — last night for Nonna, Danny & Effie', time: '20:30', highlight: true },
        ],
      },
    ],
  },
  {
    ...
    subtitle: '4 couples embark Naples · Capri · Positano · Stromboli · Aeolians · Catania · Aug 24–28',
    ...
    days: [
      {
        date: 'Monday · Aug 24',
        isoDate: '2026-08-24',
        title: 'Naples — Handover Day → Depart for Capri',
        subtitle: 'Family disembarks AM · 4 couples embark AM · Depart Mergellina at noon · Overnight Capri',
        imageUrl: satelliteImage('14.20,40.81,14.30,40.87', '640,320'),
        imageCaption: 'Naples — Mergellina harbour, Vesuvius across the bay',
        dock: {
          marina: 'Porto di Mergellina · Napoli',
          marinaLink: mapsLink('Porto di Mergellina Napoli'),
          radioChannel: 'Ch 09',
          eta: 'Docked from Aug 19',
          etd: 'Aug 24 noon',
          notes: 'Family (Nonna, Danny, Effie, Daniel, Marco) all disembark this morning. Carlo & Denise, Vinny & Morissa, Stacy & husband, Charlie & Cecile embark AM. Depart at noon toward Capri. Rick (Enrico) & Antoniette stay aboard.',
        },
        events: [
          { title: 'Family disembark — Nonna, Danny, Effie, Daniel & Marco', time: '08:00', highlight: true },
          { title: 'Deep-clean cabin turnover · fresh flowers', time: '08:30' },
          { title: 'Final provisioning for the friends leg' },
          { title: 'Carlo & Denise, Vinny & Morissa, Stacy & husband, Charlie & Cecile arrive at the dock', time: '10:30', highlight: true, details: ['Welcome walkthrough · champagne on the sundeck'] },
          { title: 'Depart Mergellina for Capri', time: '12:00', highlight: true, details: ['Short hop across the Bay of Naples'] },
          { title: 'Anchor Marina Piccola — Faraglioni views', time: '15:30', link: mapsLink('Marina Piccola Capri') },
          ...
          { title: 'Welcome dinner aboard at anchor', time: '20:30', highlight: true },
        ],
      },
      {
        date: 'Tuesday · Aug 25',
      ...
      },
      {
        ...
        events: [
          ...
          { title: 'Depart ~10 PM for Aeolian Islands — Leg 7', time: '22:00', details: ['~155 nm · 12h 55m at 12 kn', 'Arrive Stromboli ~11 AM Aug 27'], highlight: true },
        ],
        leg: {
          label: 'LEG 7 · NIGHT PASSAGE',
          route: 'Naples / Amalfi → Stromboli, Aeolian Islands',
          sub: 'Depart ~10 PM Aug 26 · Arrive ~11 AM Aug 27',
          miles: '178',
          duration: '12h 55m',
          knots: '12',
        },
      ...
      },
      {
        date: 'Friday · Aug 28',
        isoDate: '2026-08-28',
        title: 'Aeolian Hop → Catania — Baroque Lava City',
        subtitle: 'Morning Panarea & Lipari · Afternoon transit to Catania · Depart ~9 PM for Malta',
        ...
        dock: {
          ...
          eta: '~19:30',
          etd: '~21:00',
          notes: 'Short evening stop. Four couples disembark before Malta night crossing.',
        },
        events: [
          ...
          { title: 'Lipari quick stop — castle photo + Filippino lunch', time: '12:30', link: mapsLink('Filippino Lipari'), details: ['Family-run since 1910 · best swordfish in the Aeolians'], locationImage: satelliteImage('14.93,38.45,15.00,38.52', '320,160') },
          { title: 'Lift anchor — depart for Catania', time: '14:30', details: ['~7 h transit south to Catania', 'Four couples disembark tonight before Malta crossing'] },
          { title: 'Arrive Porto di Catania — dock', time: '19:30', link: mapsLink('Porto di Catania Sicilia'), highlight: true },
          { title: 'Farewell dinner ashore — Sapio (1 Michelin Star)', time: '20:15', link: mapsLink('Sapio Catania'), details: ['Volcanic soil ingredients · best in Catania'] },
          { title: 'Four couples disembark at Catania', time: '20:45', highlight: true, details: ['Carlo & Denise, Vinny & Morissa, Stacy & husband, Charlie & Cecile'] },
