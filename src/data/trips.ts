  ...
  // =================================================================
  {
    ...
    days: [
      ...
      },
      {
        ...
        isoDate: '2026-09-13',
        title: 'Guest Swap in Taormina → Night Crossing',
        subtitle: 'Day 40 · Daniel, Laura, Marco, Deanna, Candace & Dog depart · Brianna & Matt arrive',
        events: [
          ...
          { time: '00:00', title: 'Depart Taormina for Grotta di San Gregorio — overnight passage (100 NM, 10h)', highlight: true, link: mapsLink('Grotta di San Gregorio Leuca') },
        ],
        overnight: 'Underway \u2192 Grotta di San Gregorio',
        leg: {
          label: 'Leg 12 · Ionian Night Passage',
          route: 'Taormina, Sicily \u2192 Grotta di San Gregorio (Salento)',
          sub: 'Depart 00:00 Sep 14 · Arrive ~10:00 Sep 14',
      ...
      },
      {
        ...
        isoDate: '2026-09-14',
        title: 'Grotta di San Gregorio → Corfu',
        subtitle: 'Day 41 · Arrive 10 AM · Sea caves & beach · Depart 17:00 for Corfu',
        imageUrl: satelliteImage({ west: 18.30, south: 39.75, east: 18.45, north: 39.90 }, { w: 1000, h: 450 }),
        imageCaption: 'Grotta di San Gregorio — Salento sea caves',
        events: [
          { time: '10:00', title: 'Arrive Grotta di San Gregorio — anchor', link: mapsLink('Grotta di San Gregorio Patu'), highlight: true },
          { title: 'Swim from the boat' },
          { title: 'Tender expedition to the beach' },
          { title: 'Tender to the caves & grottos along the cliffline' },
          { time: '17:00', title: 'Weigh anchor for Corfu — overnight passage', highlight: true, link: mapsLink('Corfu Marina Gouvia') },
        ],
        overnight: 'Underway \u2192 Corfu',
        leg: {
          label: 'Leg 13 · Otranto Channel Crossing',
          route: 'Grotta di San Gregorio (Salento) \u2192 Corfu, Greece',
          sub: 'Depart 17:00 Sep 14 · Arrive ~12:00 Sep 15',
    ...
    days: [
      {
        ...
        isoDate: '2026-09-15',
        title: 'Arrive Corfu — Dock',
        subtitle: 'Day 42 · Arrive noon · Dock at Marina Gouvia',
        ...
        events: [
          { time: '12:00', title: 'Arrive Corfu — Marina Gouvia', link: mapsLink('Marina Gouvia Corfu'), highlight: true },
    ...
    days: [
      {
        ...
        isoDate: '2026-09-17',
        title: 'Sivota → Paxos → Gaios',
        subtitle: 'Day 44 · Depart 07:00 · Anchor Paxos 08:30 · Dock Gaios 16:00',
        ...
        dock: {
          marina: 'Gaios, Paxos',
          marinaLink: mapsLink('Gaios Paxos port'),
          radioChannel: 'Ch 12',
          eta: '~16:00 Sep 17',
          etd: '~05:00 Sep 18',
          notes: 'Small harbor — stern-to on the town quay, arrange with port police',
        },
        events: [
          ...
          { time: '16:00', title: 'Move to dock at Gaios, Paxos', link: mapsLink('Gaios Paxos'), highlight: true, details: ['Paxos capital — wander the Venetian waterfront, small chapels, tiny alleys'] },
        ...
        overnight: 'Gaios, Paxos',
        leg: {
          label: 'Leg 13 · Sivota → Paxos',
          route: 'Sivota \u2192 Ortholithos (Paxos) \u2192 Antipaxos \u2192 Gaios',
          sub: 'Depart 07:00 Sep 17 · Dock 16:00 Sep 17',
          miles: 40,
    ...
    days: [
      {
        ...
        subtitle: 'Day 45 · Depart 05:00 · Mathraki 09:30 · Braghini 12:00 · Porto Palermo evening',
        ...
        events: [
          { time: '05:00', title: 'Depart Gaios, Paxos', link: mapsLink('Gaios Paxos') },
        ...
        leg: {
          ...
          sub: 'Depart 05:00 Sep 18 · Anchor ~19:00 Sep 18',
          miles: 90,
      ...
      },
      {
        ...
        isoDate: '2026-09-19',
        title: 'Gjipe Canyon & Dhermi',
        subtitle: 'Day 46 · Gjipe 10:00 · Dhermi 16:00 · Havana Beach Club evening',
        imageUrl: satelliteImage({ west: 19.55, south: 40.05, east: 19.75, north: 40.20 }, { w: 1000, h: 450 }),
        imageCaption: 'Gjipe → Dhermi, Albanian Riviera',
        events: [
          ...
          { title: 'Evening at the beach — dinner & party at night', details: ['Book a beach bed; kitchen runs late'] },
        ],
        overnight: 'Anchored — off Dhermi',
        leg: {
          label: 'Leg 15 · Porto Palermo → Dhermi',
          route: 'Porto Palermo \u2192 Gjipe \u2192 Dhermi',
          sub: '~15 nm total · hops with swim stops',
          miles: 17,
          duration: '~2h underway',
          knots: 11,
        },
      },
      {
        ...
        isoDate: '2026-09-20',
        title: 'Secret Blue Cave → Vlorë (Orikum)',
        subtitle: 'Day 47 · Secret Blue Cave morning · Dock Orikum 13:00 · Brianna & Matt depart 15:00',
        imageUrl: satelliteImage({ west: 19.30, south: 40.15, east: 19.55, north: 40.50 }, { w: 1000, h: 450 }),
        imageCaption: 'Karaburun peninsula → Vlorë Bay',
        dock: {
          marina: 'Orikum Marina, Vlorë',
          marinaLink: mapsLink('Orikum Marina Vlore Albania'),
          radioChannel: 'Ch 09',
          eta: '~13:00 Sep 20',
          notes: 'Only full-service marina on the Albanian coast — fuel, water, customs',
        },
        events: [
          { title: 'Morning anchor — Secret Blue Cave', link: 'https://www.google.com/maps/place/Secret+Blue+Cave/@40.2348111,19.4478671', highlight: true, details: ['Sea cave on the Karaburun peninsula — luminous blue light when the sun is right; tender in only'] },
          { title: 'Tender to shore — swim & explore the cave', details: ['Karaburun-Sazan Marine Park — the wildest coast in the Ionian'] },
          { time: '11:00', title: 'Lift anchor — lunch underway to Vlorë (~2h)', link: mapsLink('Vlore Albania') },
          { time: '13:00', title: 'Dock at Orikum Marina', link: mapsLink('Orikum Marina Vlore Albania'), highlight: true, details: ['Orikum is a natural lagoon south of Vlorë — the ancient Greek Oricum sat on this shore'] },
          { title: 'Walk the historical town & waterfront promenade', link: mapsLink('Vlore waterfront promenade Lungomare'), details: ['Vlorë\u2019s seafront Lungomare — palm-lined promenade, monument of Independence, cafes'] },
          { title: 'Optional ashore: ruins of ancient Oricum', link: mapsLink('Oricum ruins Albania'), details: ['Greek/Roman settlement inside the modern Pasha Liman naval base — permit required'] },
          { time: '15:00', title: 'Brianna & Matt depart for the airport', highlight: true, details: ['Vlorë → Tirana International (TIA), ~2h30 by car'] },
        ],
        overnight: 'Orikum Marina, Vlorë',
        leg: {
          label: 'Leg 16 · Dhermi → Vlorë',
          route: 'Dhermi \u2192 Secret Blue Cave \u2192 Orikum Marina',
          sub: 'Anchor early · Dock ~13:00 Sep 20',
          miles: 30,
          duration: '~3h 30m underway',
          knots: 11,
        },
      },
    ],
