  ...
  },
  {
    ...
    days: [
      ...
      },
      {
        ...
        isoDate: '2026-08-27',
        title: 'Pumice Cove → Grotta Fosforescente → Porto di Vulcano',
        subtitle: 'Breakfast at anchor · tender to the fluorescent grotto · evening in Vulcano · Guest’s choice: dinner ashore or aboard',
        imageUrl: satelliteImage('14.90,38.35,15.10,38.55', '640,320'),
        imageCaption: 'Lipari · Vulcano — pumice quarry, fluorescent grotto, Porto di Vulcano',
        overnight: 'At anchor · Porto di Vulcano',
        events: [
          { title: 'Reposition to ex Cava di Pietra Pomice — anchor by 09:00', time: '09:00', highlight: true, link: mapsLink('Cava di Pomice Lipari'), details: ['Breakfast at anchor', 'Swim call · optional beach exploration'] },
          { title: 'Weigh anchor — short hop to Grotta Fosforescente, Lipari (~30 min)', time: '12:00', highlight: true, link: mapsLink('Grotta Fosforescente Lipari'), details: ['Tender expedition into the grotto'] },
          { title: 'Reposition to Porto di Vulcano (~1h) — anchor', time: '16:00', highlight: true, link: mapsLink('Porto di Vulcano') },
          { title: 'Tender expedition ashore', details: ['Guest’s choice: dinner ashore in Vulcano or aboard at anchor'] },
        ],
      },
      {
        date: 'Friday · Aug 28',
