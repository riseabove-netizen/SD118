...
export const TRIPS: Trip[] = [
  ...
  },
  {
    ...
    guests: 'Nonna, Daniel, Marco & cousins aboard Aug 19 · Cousins disembark Aug 20 in Naples · Danny & Effie arrive ~14:00 Aug 20 · Big dock party Aug 21',
    guestList: [
      { name: 'Enrico' },
      { name: 'Antoniette' },
    ...
    days: [
      ...
      },
      {
        ...
        isoDate: '2026-08-20',
        title: 'Ischia → Naples · Cousins Off · Danny & Effie Aboard',
        subtitle: 'Return to Naples · Dock by lunch · Cousins disembark · Danny & Effie arrive ~14:00 · Possible evening cruise',
        imageUrl: satelliteImage('13.90,40.72,14.30,40.87', '640,320'),
        imageCaption: 'Ischia → Marina Molo Luise, Mergellina',
        ...
        dock: {
          ...
          radioChannel: 'Ch 09',
          eta: '~12:30 Aug 20',
          etd: 'Aug 20 PM (possible evening cruise · return before dark)',
          notes: 'Cousins disembark on arrival at Molo Luise. Danny & Effie board ~14:00. Optional evening cruise around the bay, back before dark.',
        },
        events: [
          { title: 'Weigh lines · depart Ischia for Naples', time: '10:30', highlight: true, details: ['~18 nm · ~2h at 12 kn', 'Coffee & light breakfast underway'] },
          { title: 'Arrive Naples · dock Marina Molo Luise', time: '12:30', link: mapsLink('Marina Molo Luise Mergellina Napoli'), highlight: true, details: ['Stern-to as before', 'Passerelle rigged for guest turnover'] },
          { title: 'Cousins disembark', time: '12:45', highlight: true, details: ['Farewells at the passerelle', 'Cabins cleared for turnover'] },
          { title: 'Lunch aboard with Nonna, Daniel & Marco', time: '13:00' },
          { title: 'Cabin turnover for Danny & Effie', time: '13:15' },
          { title: 'Danny & Effie arrive at the dock · board', time: '14:00', highlight: true, details: ['Welcome + orientation aboard'] },
          { title: 'Possible evening cruise — bay of Naples loop', time: '17:00', highlight: true, details: ['Captain’s call based on wind & guest preference', 'Posillipo coastline · Vesuvius panorama at sunset', 'Return Molo Luise before dark'] },
          { title: 'Return to Molo Luise · re-dock', time: '19:30', details: ['Stern-to Mergellina', 'Evening aboard with the family'] },
          { title: 'Dinner aboard — whole family together', time: '20:30' },
        ],
        leg: {
          label: 'LEG · ISCHIA → NAPLES',
          route: 'Ischia → Marina Molo Luise, Mergellina',
          sub: 'Depart 10:30 Aug 20 · Arrive ~12:30 Aug 20',
          miles: '18',
          duration: '2h',
          knots: '12',
        },
