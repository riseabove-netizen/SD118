  ...
  },
  {
    ...
    days: [
      ...
      },
      {
        ...
        isoDate: '2026-08-26',
        title: 'Stromboli → Lipari → Vulcano',
        subtitle: 'Morning volcano watch · black-sand beach tender · Aeolian island hop · Overnight at Scoglio Brigantino',
        imageUrl: satelliteImage('14.90,38.40,15.30,38.85', '640,320'),
        imageCaption: 'Aeolian Islands — Stromboli → Lipari → Vulcano',
        overnight: 'At anchor · Scoglio Brigantino',
        events: [
          { title: 'Arrive Stromboli — anchor for morning volcano watch', time: '08:00', highlight: true, link: mapsLink('Stromboli volcano'), details: ['Eruptions roughly every 30 minutes'], locationImage: satelliteImage('15.19,38.78,15.25,38.82', '320,160') },
          { title: 'Tender expedition to the black-sand beach', link: mapsLink('Spiaggia Lunga Stromboli') },
          { title: 'Weigh anchor — short hop to Spiaggia di Cala Camardei (~1h)', time: '12:30', highlight: true, details: ['Swim call from the swim platform'], locationImage: satelliteImage('14.94,38.43,14.97,38.46', '320,160') },
          { title: 'Move to Scoglio Brigantino (~30 min) — anchor for the night', time: '17:00', highlight: true },
        ],
      },
      {
        date: 'Thursday · Aug 27',
        isoDate: '2026-08-27',
        title: 'Vulcano Mud Baths → Grotta Fosforescente → Dinner at Hotel Orsa Maggiore',
        subtitle: 'Sulphur breakfast at the Terme · tender to the fluorescent grotto · dinner ashore at Orsa Maggiore, 20:00',
        imageUrl: satelliteImage('14.90,38.35,15.10,38.55', '640,320'),
        imageCaption: 'Lipari · Vulcano — Terme di Vulcano, fluorescent grotto, Porto di Vulcano',
        overnight: 'At anchor · Porto di Vulcano',
        events: [
          { title: 'Tender ashore — Terme di Vulcano mud baths for breakfast', time: '08:30', highlight: true, link: mapsLink('Terme di Vulcano fanghi'), details: ['Sulphur mud pool + hot-spring sea swim', 'Bring flip-flops · silver jewellery stays aboard (sulphur tarnishes it)'] },
          { title: 'Back aboard — short hop to Grotta Fosforescente, Lipari (~30 min)', time: '11:30', highlight: true, link: mapsLink('Grotta Fosforescente Lipari'), details: ['Tender expedition into the fluorescent grotto'] },
          { title: 'Optional swim call at ex Cava di Pietra Pomice', time: '13:00', link: mapsLink('Cava di Pomice Lipari'), details: ['White pumice seabed · water glows turquoise'] },
          { title: 'Reposition to Porto di Vulcano (~1h) — anchor', time: '16:00', highlight: true, link: mapsLink('Porto di Vulcano') },
          { title: 'Tender guests ashore for dinner', time: '19:30' },
          { title: 'Dinner at Hotel Orsa Maggiore, Vulcano', time: '20:00', highlight: true, link: mapsLink('Hotel Orsa Maggiore Vulcano'), details: ['Terrace dining above Porto di Ponente'] },
        ],
      },
      {
        date: 'Friday · Aug 28',
        isoDate: '2026-08-28',
        title: 'La Baia Negra → Capo Grosso → Scilla → Isola Bella (Taormina)',
        subtitle: 'Beach morning at Panarea · swim at Piscina di Venere · Scilla castle stop · Goodbye swim at Isola Bella',
        imageUrl: satelliteImage('14.90,37.85,15.75,38.65', '640,320'),
        imageCaption: 'Panarea → Scilla → Taormina',
        events: [
          { title: 'Anchor La Baia Negra, Panarea — breakfast on the beach with full setup', time: '08:00', highlight: true, link: mapsLink('Cala Junco Panarea'), locationImage: satelliteImage('15.06,38.62,15.09,38.65', '320,160') },
          { title: 'Weigh anchor — short hop to Capo Grosso (~45 min)', time: '13:00', highlight: true, details: ['Swim in Piscina di Venere', 'Explore Grotta del Cavallo by tender'], link: mapsLink('Piscina di Venere Capo Grosso'), locationImage: satelliteImage('15.20,38.55,15.24,38.58', '320,160') },
          { title: 'Move to a protected anchorage — rest before the early departure' },
          { title: 'Slip lines early — passage to Castello Ruffo di Scilla (~3h30)', time: '05:30', highlight: true, link: mapsLink('Castello Ruffo di Scilla'), details: ['Breakfast onboard underway', 'Guest’s choice on arrival: morning on the beach, or walk up to the castle for the views (€3 admission)'] },
          { title: 'Weigh anchor — cruise to Isola Bella, Taormina (~3h)', time: '11:00', highlight: true, link: mapsLink('Isola Bella Taormina'), details: ['Goodbye swim at anchor', 'Tender guests ashore for Taormina'] },
        ],
      },
    ],
  },
