...
export const FORMS_CATALOG: ISMForm[] = [
...

  {
    ...
    alarmBanner: false,
    items: [
      { id: 'sf-1', label: 'Prepare for anchoring in shallow water', indent: 0 },
      { id: 'sf-2', label: 'Exhibit Not Under Command lights / shapes', indent: 0 },
      { id: 'sf-3', label: 'Commence sound signaling', indent: 0 },
      { id: 'sf-4', label: 'Broadcast urgency message to ships in the vicinity (steering failure)', indent: 0 },
      { id: 'sf-5', label: 'Engage emergency steering', indent: 0 },
      { id: 'sf-6', label: 'Keep away from ships and traffic', indent: 0 },
      { id: 'sf-7', label: 'Prepare engines for maneuvering / manual valves on gear boxes', indent: 0 },
      { id: 'sf-8', label: 'Determine proximity of traffic and navigational dangers', indent: 0 },
      { id: 'sf-9', label: 'Request assistance from nearby vessels if possible', indent: 0 },
      { id: 'sf-10', label: 'Identify nearest anchorages or safe havens', indent: 0 },
      { id: 'sf-11', label: 'Make anchor ready', indent: 0 },
    ],
  },
...

  {
    ...
    items: [
      ...
      { id: 'med-vs', label: 'Human vital signs (reference)', indent: 0, isGroup: true, noCheckbox: true },
      { id: 'med-vs-1', label: 'Breathing (adult): 12–16 breaths per minute', indent: 1, noCheckbox: true },
      { id: 'med-vs-2', label: 'Breathing (babies / young kids): 20–30 breaths per minute', indent: 1, noCheckbox: true },
      { id: 'med-vs-3', label: 'Pulse: 60–80 beats per minute (faster in babies or children)', indent: 1, noCheckbox: true },
      { id: 'med-vs-4', label: 'Body temperature: 36.9 °C', indent: 1, noCheckbox: true },
      { id: 'med-vs-5', label: 'Blood pressure: 120 / 80', indent: 1, noCheckbox: true },
    ],
  },

  {
    ...
    alarmBanner: true,
    items: [
      { id: 'mob-1', label: 'Release lifebuoy with light + hand smoke signal on the side the person has fallen', indent: 0 },
      { id: 'mob-2', label: 'Sound 3 prolonged blasts on the ship’s whistle (repeat as necessary); ring general alarm', indent: 0 },
      { id: 'mob-3', label: 'Activate MOB function on GPS — note ship position, wind speed, direction and time', indent: 0 },
      { id: 'mob-4', label: 'Post lookout with binoculars — maintain continuous visual watch on the MOB', indent: 0 },
      { id: 'mob-5', label: 'Place engines on stand-by', indent: 0 },
      { id: 'mob-6', label: 'Perform MOB yacht manoeuvres', indent: 0 },
      { id: 'mob-7', label: 'Crew ready with life jackets, fins and security line', indent: 0 },
      { id: 'mob-8', label: 'Prepare medical kit', indent: 0 },
      { id: 'mob-9', label: 'Man searchlights', indent: 0 },
      { id: 'mob-10', label: 'Launch rescue boat to recover casualty', indent: 0 },
      { id: 'mob-11', label: 'Distribute UHF / VHF for communication', indent: 0 },
      { id: 'mob-12', label: 'Broadcast a MAYDAY alert', indent: 0 },
      { id: 'mob-13', label: 'Administer first aid as required', indent: 0 },
      { id: 'mob-14', label: 'Identify suitable landing point to disembark casualty if required', indent: 0 },
      { id: 'mob-15', label: 'Contact contracted medical assistance', indent: 0 },
    ],
  },

  {
    ...
    alarmBanner: true,
    items: [
      { id: 'mpf-1', label: 'Prepare for anchoring in shallow water', indent: 0 },
      { id: 'mpf-2', label: 'Exhibit Not Under Command lights / shapes', indent: 0 },
      { id: 'mpf-3', label: 'Commence sound signaling', indent: 0 },
      { id: 'mpf-4', label: 'Keep away from ships and traffic', indent: 0 },
      { id: 'mpf-5', label: 'Prepare engines for maneuvering / manual valves on gear boxes', indent: 0 },
      { id: 'mpf-6', label: 'Can the yacht be manoeuvred', indent: 0 },
      { id: 'mpf-7', label: 'Identify nearest anchorages or safe haven', indent: 0 },
      { id: 'mpf-8', label: 'Request assistance from nearby vessels', indent: 0 },
      { id: 'mpf-9', label: 'Determine if repairs can be made in-situ', indent: 0 },
      { id: 'mpf-10', label: 'Prepare tow if required', indent: 0 },
    ],
  },
...

  {
    ...
    items: [
      ...
      { id: 'fld-4', label: 'Prepare lifejackets', indent: 0 },
      { id: 'fld-5', label: 'Switch on deck lighting at night', indent: 0 },
      { id: 'fld-6', label: 'Muster passengers, if carried, at emergency stations (Main or Fly Deck)', indent: 0 },
      { id: 'fld-7', label: 'Remove passengers away from the damaged area', indent: 0 },
      { id: 'fld-8', label: 'Check bilges and tanks statement', indent: 0 },
      { id: 'fld-9', label: 'Check for fire and damage', indent: 0 },
      { id: 'fld-10', label: 'Prepare emergency pump valve for fire or flooding position', indent: 0 },
      { id: 'fld-11', label: 'Start bilge pumps', indent: 0 },
      { id: 'fld-12', label: 'Ready emergency bilge pump', indent: 0 },
      { id: 'fld-13', label: 'Switch off electric sources on compartment involved', indent: 0 },
      { id: 'fld-14', label: 'Passengers mustered & counted', indent: 0 },
      { id: 'fld-15', label: 'All persons not involved in response to don lifejackets', indent: 0 },
      { id: 'fld-16', label: 'Assess damage paying particular attention to stability', indent: 0 },
      { id: 'fld-17', label: 'Broadcast distress alert and message if the ship is in grave and imminent danger', indent: 0 },
      { id: 'fld-18', label: 'Offer / give assistance to other ship if appropriate', indent: 0 },
      { id: 'fld-19', label: 'Drop the tender off if appropriate', indent: 0 },
      { id: 'fld-20', label: 'Identify nearest safe haven or landing point', indent: 0 },
      { id: 'fld-21', label: 'Request assistance from nearby vessels', indent: 0 },
      { id: 'fld-22', label: 'Ready liferafts for deployment', indent: 0 },
      { id: 'fld-23', label: 'Initiate PAN PAN or MAYDAY', indent: 0 },
    ],
    specificIncidents: {
      columns: [
        {
...

  {
    ...
    alarmBanner: true,
    items: [
      { id: 'fire-1', label: 'Sound general alarm', indent: 0 },
      { id: 'fire-2', label: 'Acknowledge alarm on panel and confirm real localization', indent: 0 },
      { id: 'fire-3', label: 'Establish communications through UHF', indent: 0 },
      { id: 'fire-4', label: 'Check for missing and injured persons', indent: 0 },
      { id: 'fire-5', label: 'If engine room is on fire, prepare for engine failure and abandon ship', indent: 0 },
      { id: 'fire-6', label: 'Prepare the emergency pump / ready emergency fire pump', indent: 0 },
      { id: 'fire-7', label: 'Guests on the opposite side, with life jackets and flashlights', indent: 0 },
      { id: 'fire-8', label: 'Position the ship on windward side if possible', indent: 0 },
      { id: 'fire-9', label: 'Close down ventilation fans and doors; isolate electric zone', indent: 0 },
      { id: 'fire-10', label: 'Close Dampers and Ready Emergency Fuel Cutoffs', indent: 0 },
      { id: 'fire-11', label: 'Remove passengers away from the source of fire', indent: 0 },
      { id: 'fire-12', label: 'Deploy fire fighting team', indent: 0 },
      { id: 'fire-13', label: 'Treat and record any injuries to passengers and crew', indent: 0 },
      { id: 'fire-14', label: 'Muster and count passengers and crew not involved in dealing with incident', indent: 0 },
      { id: 'fire-15', label: 'All persons not involved in fighting fire to don lifejackets', indent: 0 },
      { id: 'fire-16', label: 'Broadcast a security alert if the ship is in grave or imminent danger', indent: 0 },
      { id: 'fire-17', label: 'If assistance is required, broadcast a MAYDAY message', indent: 0 },
      { id: 'fire-18', label: 'Identify nearest safe haven or landing point', indent: 0 },
      { id: 'fire-19', label: 'Request assistance from nearby vessels', indent: 0 },
      { id: 'fire-20', label: 'Ready liferafts for deployment', indent: 0 },
      { id: 'fire-21', label: 'Initiate PAN PAN or MAYDAY', indent: 0 },
      { id: 'fire-det', label: 'Determinate:', indent: 0, isGroup: true, noCheckbox: true },
      { id: 'fire-det-1', label: 'The class of fire (A / B / C / E)', indent: 1 },
      { id: 'fire-det-2', label: 'Appropriate extinguishing agent', indent: 1 },
      { id: 'fire-det-3', label: 'Appropriate method of attack', indent: 1 },
    ],
    specificIncidents: {
      columns: [
        {
...

  {
    ...
    items: [
      ...
      { id: 'col-3', label: 'Prepare lifejackets', indent: 0 },
      { id: 'col-4', label: 'Switch on deck lighting at night', indent: 0 },
      { id: 'col-5', label: 'Muster passengers, if carried, at emergency stations (Main or Fly Deck)', indent: 0 },
      { id: 'col-6', label: 'Remove passengers away from the damaged area', indent: 0 },
      { id: 'col-7', label: 'Check bilges and tanks statement after collision', indent: 0 },
      { id: 'col-8', label: 'Check for fire and damage', indent: 0 },
      { id: 'col-9', label: 'Assess damage throughout whole vessel and sound tanks', indent: 0 },
      { id: 'col-10', label: 'Prepare emergency pump valve for fire or flooding position', indent: 0 },
      { id: 'col-11', label: 'Start bilge pumps if hull is breached or water is being taken on board', indent: 0 },
      { id: 'col-12', label: 'Switch off electric sources on compartment involved', indent: 0 },
      { id: 'col-13', label: 'Muster and count passengers and crew not involved in dealing with incident', indent: 0 },
      { id: 'col-14', label: 'Offer assistance to other ship', indent: 0 },
      { id: 'col-15', label: 'Broadcast distress alert and message if the ship is in grave and imminent danger', indent: 0 },
      { id: 'col-16', label: 'Give assistance if required, otherwise broadcast an emergency message to ships in vicinity', indent: 0 },
      { id: 'col-17', label: 'Drop the tender off if appropriate', indent: 0 },
      { id: 'col-18', label: 'Identify nearest landing point', indent: 0 },
      { id: 'col-19', label: 'Request assistance from nearby vessels', indent: 0 },
      { id: 'col-20', label: 'Display navigation lights / shapes & illuminate muster & embarkation areas', indent: 0 },
      { id: 'col-21', label: 'Prepare liferafts to be deployed if required', indent: 0 },
      { id: 'col-22', label: 'Prepare SART + EPIRB', indent: 0 },
    ],
    specificIncidents: {
      columns: [
        {
  ...
  {
    formId: 'abandoning-ship',
    formName: 'Abandoning Ship',
    formType: 'emergency',
    category: 'Emergency Procedures',
    alarmBanner: true,
    headerNote: 'Only order abandonment when the vessel is in grave and imminent danger and it is safer to leave than to remain on board.',
    items: [
      { id: 'abs-1', label: 'Broadcast distress alert and message to the authorities', indent: 0 },
      { id: 'abs-2', label: 'Instruct crew and guests to put on lifejackets and wear adequate warm clothing', indent: 0 },
      { id: 'abs-3', label: 'Prepare to launch life rafts — ensure sea painters are attached to the ship', indent: 0 },
      { id: 'abs-4', label: 'Close bunker valves', indent: 0 },
      { id: 'abs-5', label: 'Turn off generators', indent: 0 },
      { id: 'abs-6', label: 'Prepare SART + EPIRB', indent: 0 },
      { id: 'abs-7', label: 'Take ship’s papers, medical kit, portable VHF, GPS, flares and extra warm clothing / water if time permits', indent: 0 },
      { id: 'abs-8', label: 'Embark all guests and crew into the life rafts or tender if appropriate', indent: 0 },
      { id: 'abs-9', label: 'Ensure life rafts / tender remain in safe proximity to the ship and in contact with each other', indent: 0 },
      { id: 'abs-10', label: 'Muster — verify head count against crew and guest list', indent: 0 },
      { id: 'abs-11', label: 'Maintain a continuous listening watch on VHF Ch 16', indent: 0 },
    ],
  },
]
